...
class Position:
    def __init__(self, window, x, y, unit=PositionUnit.PIXELS, reference=PositionReference.TOP_LEFT):
        self.window = window
    ...
    def get(self, elementSize=(0, 0), reference=PositionReference.TOP_LEFT):
        match reference:
